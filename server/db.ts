...
// Consultation request queries
import { consultationRequests, InsertConsultationRequest } from "../drizzle/schema";
...
export async function getConsultationRequests(limit: number = 50, offset: number = 0) {
  const db = await getDb();
  if (!db) {
